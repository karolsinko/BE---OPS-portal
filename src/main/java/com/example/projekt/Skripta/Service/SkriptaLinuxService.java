...
public class SkriptaLinuxService {
    ...
    public static Skripta mapSkripta(SkriptaLinuxEntity skriptaLinuxEntity) {
        Skripta skripta = new Skripta(skriptaLinuxEntity.getId(), skriptaLinuxEntity.getContent(), skriptaLinuxEntity.getContent1(), skriptaLinuxEntity.getCommands(), skriptaLinuxEntity.getExplain());
