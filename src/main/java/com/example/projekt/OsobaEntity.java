...
public class OsobaEntity {
    ...
    public String getTel_cislo(){return tel_cislo;}

    public String getBydlisko() { return bydlisko; }
    ...
    public void setTel_cislo(String tel_cislo) {this.tel_cislo = tel_cislo;}
